    ...
    'admin': {
        controllers:{ 
             ...
             'banner2':{
                ...
                actions: {
                    'index': function () {
                        yOSON.AppCore.runModule('addLink');
                        yOSON.AppCore.runModule('selLink');
                    },
                    'byDefault': function () {
                    }
                },
...
//                        yOSON.AppCore.runModule('dataTable',{"url":"/admin/musica/list","table":"#tblMusica"});
                        yOSON.AppCore.runModule('dataTable',{"url":"/admin/musica/list","table":"#tdAction3"});
                        yOSON.AppCore.runModule('actionDel');
                    },
                    'byDefault':function(){}
                },
...
//                        yOSON.AppCore.runModule('dataTable',{"url":"/admin/juego/list","table":"#tblJuego"});
                        yOSON.AppCore.runModule('dataTable',{"url":"/admin/juego/list","table":"tdAction3"});
                        yOSON.AppCore.runModule('actionDel');
                    },
                    'byDefault':function(){}
                },
