...
yOSON.AppCore.addModule("addBanner", (function(Sb) {
    ...
    bindEvents = function() {
        $.jqFile({
            "nameFile": "imagen",
            "routeFile": "/admin/banner/banner-image",
...
yOSON.AppCore.addModule("addLink", (function(Sb) {
    var bindEvents, catchDom, dom, evtClose, st, successFile, tmpl;
    st = {
        sort: "#sortBanner",
        btnClose: ".ic-close",
    ...
    bindEvents = function() {
        $.jqFile({
            "nameFile": "imagen",
            "routeFile": "/admin/link/banner-image",
            "btnFile": ".ctn-file .btn-file",
            "beforeCharge": function() {
                return utils.loader(dom.ctnBanner, true);
            },
...
yOSON.AppCore.addModule("selLink", (function(Sb) { 
    var bindEvents, catchDom, dom, st;
    st = {
        slct: "#type"
    };
